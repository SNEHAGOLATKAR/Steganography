...
public class Steganograph
{
	...
	private static class AboutFrame extends JFrame implements ActionListener
	{
		...
		public AboutFrame()
		{
			...
			lblName= new MyJLabel("By:   Sneha", new Font("Times New Roman", Font.BOLD, 14), RED, BLACK);
			lblEmail= new MyJLabel("      snehagolatkar99@gmail.com", GREEN, BLACK);
			lblPhone= new MyJLabel("      +91 9167776456", GREEN, BLACK);
...
class HTMLFrame extends JFrame implements HyperlinkListener
{
	...
	{
		super("Help - Steganograph "+ Steganograph.VERSION+ " -- By: Sneha");
		...
		if(isOnline)
		{
			...
			setTitle("Steganograph "+ Steganograph.VERSION+ " -- By: Sneha");
		}
		//else
