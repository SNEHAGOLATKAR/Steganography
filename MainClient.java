...
public class MainClient extends WindowAdapter implements ActionListener
{
	...
	private MainClient()
	{
		mainFrame= new JFrame("Steganograph "+ Steganograph.VERSION+ "    --  By: TYIF");
		...
		Font myFont= new Font("Algerian", Font.ITALIC, 18);
		lblName= new MyJLabel("By:-   SNEHA", myFont, Color.red, Color.white);
		lblEmail= new MyJLabel("snehagolatkar99@gmail.com", arialFont, myColor, Color.white);
		lblPhone= new JLabel(" ");
